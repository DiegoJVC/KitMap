...
public class  SpawnListener implements Listener {
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        if (DTRHCFClaim.SAFE_ZONE.appliesAt(event.getBlock().getLocation())) {
            ...
            if (!DTRHCFClaim.SAFE_ZONE.appliesAt(event.getBlock().getLocation()) && event.getItemInHand() != null && event.getItemInHand().getType() == Material.WEB && (HCFactions.getInstance().getMapHandler().isKitMap() || HCFactions.getInstance().getServerHandler().isCobelKitMap())) {
    ...
    public void onDrop(PlayerDropItemEvent event) {
        ...
        if (faction != null && faction.hasDTRHCFClaim(DTRHCFClaim.SAFE_ZONE) && (HCFactions.getInstance().getServerHandler().isCobelKitMap())) {
