...
public class SpawnTagListener implements Listener {
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        if (player.getGameMode() == GameMode.CREATIVE || !SpawnTagHandler.isTagged(player) || HCFactions.getInstance().getServerHandler().isCobelKitMap() || HCFactions.getInstance().getServerHandler().isPlaceBlocksInCombat()) {
            return;
        }
