    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (!event.getPlayer().hasPlayedBefore()) {
            ...
            if (!HCFactions.getInstance().getMapHandler().isKitMap() && !HCFactions.getInstance().getServerHandler().isCobelKitMap()) {
                ...
                event.getPlayer().getInventory().addItem(FIRST_SPAWN_IRON_PICKAXE);
                event.getPlayer().getInventory().addItem(FIRST_SPAWN_IRON_SWORD);
                event.getPlayer().getInventory().addItem(FIRST_SPAWN_DIAMOND_AXE);
                event.getPlayer().getInventory().addItem(FIRST_SPAWN_DIAMOND_SPADE);
            }
