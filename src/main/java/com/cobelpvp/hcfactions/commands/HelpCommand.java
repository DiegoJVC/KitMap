...
public class HelpCommand {
    ...
    public static void helpCommand(Player player) {
        ...
        player.sendMessage(ChatColor.BLUE + "* " + ChatColor.RED +"HCFactions Map 0");
        player.sendMessage(ChatColor.BLUE + "* " + ChatColor.RED +"Map Started: 29/10/2022");
        ...
        player.sendMessage(ChatColor.GREEN + "10 man per Faction" + ChatColor.RED + (" (Allies is not allowed)"));
